...
BEGIN;
    ...
    SELECT throws_ok(
        ...
        'input value too long for type nvarchar2(5)',
    ...
    SELECT throws_ok(
        ...
        'input value too long for type nvarchar2(5)',
        'NVARCHAR2 does not truncate whitespaces on implicit coercion'
    );
    ...
    SELECT lives_ok(
        'INSERT INTO orafce_test VALUES (''abcdef''::NVARCHAR2(5));',
        'Test a value is truncated on implcit type casting'
    );

    SELECT lives_ok(
        'INSERT INTO orafce_test VALUES (''abcde ''::NVARCHAR2(5));',
